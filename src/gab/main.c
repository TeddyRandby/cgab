...
/*  // twice does not seem to be supported and messed with the cursor
 * position.*/
/*  if (visual_mode)*/
/*    endwin();*/
/*  fprintf(stderr, "%s\n", msg);*/
...
/*}*/
/**/
/*// Checks errors for (most) ncurses functions. CHECK(fn, x, y, z) is a
 * checked*/
/*// version of fn(x, y, z).*/
/*#define CHECK(fn, ...) \*/
/*  do \*/
...
/**/
/*// Calculates the cursor column for the readline window in a way that
 * supports*/
/*// multibyte, multi-column and combining characters. readline itself
 * calculates*/
...
/*//*/
/*// 'offset' is the current horizontal offset within the line. This is used
 * to*/
/*// get tab stops right.*/
/*//*/
...
/*}*/
/**/
/*// Not bothering with 'input_avail' and just returning 0 here seems to do
 * the*/
...
/*  // consistent when we turn the cursor on and off (maybe it would make
 * sense*/
...
/*  // Allow strings longer than the message window and show only the last
 * part*/
