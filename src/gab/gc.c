...
void __gab_gc_iref(gab_engine *gab, gab_vm* vm, gab_value obj, const char *file, i32 line) {
...
void __gab_gc_dref(gab_engine *gab, gab_vm* vm, gab_value obj, const char* file, i32 line) {
  if (GAB_VAL_IS_OBJ(obj)) {
